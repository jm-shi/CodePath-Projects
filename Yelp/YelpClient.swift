...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ term: String, offset: Int?, categories: [String]?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
        return searchWithTerm(term, offset: offset, sort: nil, categories: categories, deals: nil, completion: completion)
    }
